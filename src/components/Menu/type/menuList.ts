export const menus = [
  {
    ...
    component: "Layout",
    alwaysShow: true,
    meta: { title: "系统管理", icon: "el-icon-menu", roles: ["sys:system"] },
    children: [
      {
        path: "/sysUserList",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        alwaysShow: false,
        name: "houseUnit",
        meta: { title: "单元管理", icon: "table", roles: ["sys:houseUnit"] },
      },
      {
        path: "/sysHouseList",
  ...
  },
  {
    ...
    component: "Layout",
    alwaysShow: true,
    meta: { title: "⻋位管理", icon: "el-icon-money", roles: ["sys:sysPark"] },
    children: [
      {
        path: "/parkList",
  ...
  },
  {
    ...
    component: "Layout",
    alwaysShow: true,
    meta: { title: "业主管理", icon: "el-icon-s-grid", roles: ["sys:live"] },
    children: [
      {
        path: "/liveUser",
  ...
  },
  {
    ...
    component: "Layout",
    alwaysShow: true,
    meta: { title: "收费管理", icon: "el-icon-s-open", roles: ["sys:fee"] },
    children: [
      {
        path: "/feePower",
